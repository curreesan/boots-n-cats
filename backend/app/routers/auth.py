...
def _set_auth_cookies(response: Response, user_id: str) -> None:
    ...
    # secure=False: fine for local dev over http://localhost. Set True
    #           once this is deployed over https.
...
async def login(email: str, password: str, response: Response, session: AsyncSession = Depends(get_session)):
    """
